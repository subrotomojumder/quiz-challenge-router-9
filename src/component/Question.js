...
const Question = ({ questionCon, indx }) => {
    ...
    return (
        <div className='relative bg-blue-300 shadow-lg shadow-neutral-200 border rounded-md p-4 w-5/6 lg:w-2/3 mx-auto my-5'>
            ...
            <div className='absolute top-2 left-8 font-extrabold'>{isCorrect === 'initial' ? <p></p> : isCorrect === 'correct' ? <p className='text-blue-700'><CheckIcon className='w-6' /> Correct </p> : <p className='text-red-500'><XMarkIcon className='w-6' /> Wrong </p>}</div>
